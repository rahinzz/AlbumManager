...
import com.spring.SpringRest.model.Album;
import com.spring.SpringRest.model.Photo;
import com.spring.SpringRest.payload.album.AlbumPayloadDTO;
import com.spring.SpringRest.payload.album.AlbumViewDTO;
import com.spring.SpringRest.payload.album.PhotoDTO;
import com.spring.SpringRest.payload.album.PhotoPayloadDTO;
import com.spring.SpringRest.payload.album.PhotoViewDTO;
import com.spring.SpringRest.service.AccountService;
import com.spring.SpringRest.service.AlbumService;
import com.spring.SpringRest.service.PhotoService;
import com.spring.SpringRest.utils.constants.AlbumError;
import com.spring.SpringRest.utils.constants.AppUtils.AppUtil;
...
public class AlbumController {
    ...
    @SecurityRequirement(name = "album-api")
    public ResponseEntity<PhotoViewDTO> update_photoResponseEntity(@Valid @RequestBody PhotoPayloadDTO photoPayloadDTO, @PathVariable long album_id, @PathVariable long photo_id, Authentication authentication){
        try {
            String email = authentication.getName();
            Optional<Account> optionalAccount = accountService.findByEmail(email);
            Account account = optionalAccount.get();
            ...
            if(contentType.equals("image/png")
                ...
                || contentType.equals("image/jpeg")){
                    ...
                    try {
                        ...
                        File thumbnail_location = new File(AppUtil.get_photo_upload_path(finalPhotoName, THUMBNAIL_FOLDER_NAME, album_id));
    ...
    @SecurityRequirement(name = "album-api")
    @Operation(summary = "Download the thumbnail.")
    ...
    public ResponseEntity<String> delete_photo(@PathVariable long album_id, @PathVariable long photo_id, Authentication authentication){
        try {
            ...
            if(optionalPhoto.isPresent()){
                ...
                photoService.delete_photo(photo);
